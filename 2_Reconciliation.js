/**
 *代码来源： https://pomb.us/build-your-own-react/
 */
...
function commitWork(fiber) {
  ...
  // 由于组件也算作是一个fiber节点，所以我们需要来判断为父fiber是函数组件时，沿着fiber树往上找
...
let currentRoot = null; //渲染后当前构建的fiber树
let wipRoot = null; //工作的整个fiber
let deletions = null; //更新时需要删除的节点数组
